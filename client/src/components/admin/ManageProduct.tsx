...
const AdminManageProduct: React.FC = () => {
    ...
    const submitHandler = async (e: FormEvent<HTMLFormElement>): Promise<void> => {
        ...
        // Build JSON body — send variants directly, not embedded in description
        ...
        if (categoryUpdate) updateBody.category = categoryUpdate.toLowerCase();
                        ...
                        <form onSubmit={submitHandler} className="space-y-4">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div className="space-y-1">
                                    ...
                                    <input
                                        ...
                                        className="border border-[#efe9db] focus:border-[#1f5133] focus:ring-1 focus:ring-[#1f5133] focus:outline-none rounded-xl p-3 w-full text-sm font-semibold capitalize"
                                    />
                                </div>
                            ...
                            <div className="flex flex-wrap gap-3 pt-6 border-t border-[#efe9db]">
                                ...
                                <div className="ml-auto flex items-center gap-3">
                                    ...
                                    >
                                        <FaSave size={12} /> {isUpdating ? 'Saving...' : 'Save Updates'}
                                    </button>
                                </div>
                            </div>
                        </form>

  ...
  return (
    <section className="py-10 md:py-16 bg-[#FBF6ED]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        {/* Mobile: 2×2 grid | Desktop: Bento (tall-left, stacked-middle, tall-right) */}
        <div className="grid grid-cols-2 lg:grid-cols-12 gap-3 lg:gap-6 items-start">
          
          {/* === Left Column: Tall Card (Festive Urli) === */}
          <div
            onClick={() => navigate(categoryTiles[0].link)}
            className="col-span-1 lg:col-span-4 h-56 sm:h-72 lg:h-[500px] rounded-2xl lg:rounded-3xl overflow-hidden relative group cursor-pointer shadow-md border border-[#E6DACB]"
          >
            <img
          ...
          {/* === Middle Column: Two Stacked Cards (New Arrivals + Artisanal) === */}
          {/* On mobile these are individual grid cells; on desktop they stack in one column */}
          <div className="col-span-1 lg:col-span-4 flex flex-col gap-3 lg:gap-6">
            {/* New Arrivals */}
            <div
              onClick={() => navigate(categoryTiles[1].link)}
              className="h-56 sm:h-72 lg:h-[238px] rounded-2xl lg:rounded-3xl overflow-hidden relative group cursor-pointer shadow-md border border-[#E6DACB]"
            >
              <img
          ...
          {/* === Right Column: Tall Card (Fragrance Collection) === */}
          <div
            onClick={() => navigate(categoryTiles[2].link)}
            className="col-span-2 lg:col-span-4 h-56 sm:h-72 lg:h-[500px] rounded-2xl lg:rounded-3xl overflow-hidden relative group cursor-pointer shadow-md border border-[#E6DACB]"
          >
            <img
